...
Muya is a web-based Markdown editor engine extracted from [MdStorm](https://github.com/marktext/marktext). The bulk of the source today lives in `packages/core/`.
