...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark MdStorm themes', () => {
  ...
  it('uses the shared MdStorm dark theme classification', () => {
  ...
  it('uses light native menus for light MdStorm themes', () => {
